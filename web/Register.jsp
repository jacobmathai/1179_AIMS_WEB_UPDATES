                            ...
                            <div class="section group">
                                <div class="col span_2_of_3">
                                    <div class="contact-form">
                                        <form id="formID" class="formular" action="RegisterAction.jsp" method="post" name="FrmRegister">
                                            ...
                                            <label>Back Up Phone Number</label><br class="spacer" />
                                            <input type="text" name="bno" value="" maxlength="10" class="validate[required] text-input"/><br class="spacer" />
                                            <label>Username</label><br class="spacer" />
                                            <input type="text" name="uname" value="" class="validate[required] text-input" /><br class="spacer" />
                                            <label>Password</label><br class="spacer" />
                                            <input type="password" name="pswrd" value="" id="password" class="validate[required] text-input" /><br class="spacer" />
                                            <label>Confirm Password</label><br class="spacer" />
                                            <input type="password" name="cpswrd" value="" class="validate[required,equals[password]] text-input" /><br class="spacer" />
