<%-- 
    ...
    Created on : Apr 8, 2015, 1:10:19 PM
    Author     : Joji Michael
--%>
                ...
                <table border="0" cellspacing="5" cellpadding="10" align="center" >
                    ...
                    <tbody>
                        <%
                                    ...
                                    String Email = "";
                                    String phone = "";
                                    String qry = "select * from support where username!='admin'";
                                    try {
                        ...
                        %>
                        <tr>
                            <td><a href="Usersupport.jsp?uid=<%=Name%>"><%=%></a></td>
                            <td><%=username%></td>
                            <%if (status.equals("0")) {%>
                            <td><a href="UsermanageActi.jsp?user=<%=userid%>&status=1">Blocked</a></td>
                            <%} else {%>
